    ...
    },
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          type: {
            type: "string" as const,
            description: "Scene type: hero, features, testimonial, how-it-works, pricing, cta, stats, logo-cloud, comparison, faq, timeline, team, social-proof, bento-grid, gradient-text, before-after, countdown, image-showcase, video-clip, product-showcase, component-showcase, generated, or custom. Use 'generated' for custom AI-built Remotion components (requires follow-up generate_component call).",
          },
